...
const Cookies = () => {
  return (
    <div className='container bg-white rounded-3'>
      <header>
        <h1 className='text-center my-3'>Política de Cookies</h1>
      </header>
      <main>
        <section>
      ...
      <footer>
        <p>Para cualquier pregunta sobre nuestra política de cookies, por favor contáctenos en la siguiente dirección de correo electrónico: <a href="mailto:valentin.rober.dev@gmail.com">valentin.rober.dev@gmail.com</a> o <a href="mailto:algoes2002@gmail.com">algoes2002@gmail.com</a> .</p>
      </footer>
    </div>
  );
};
